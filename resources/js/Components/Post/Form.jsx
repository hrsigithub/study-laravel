    ...
    return (
        <div className="p-4">
            <div className="mb-3">
                ...
                />
                {errors.title && (
                    <div className="mt-2 text-red-500 bg-red-100 p-2 rounded">{errors.title}</div>
                )}
            </div>
            <div className="mb-3">
                <Label>本文</Label>
                ...
                />
                {errors.body && (
                    <div className="mt-2 text-red-500 bg-red-100 p-2 rounded">{errors.body}</div>
                )}
            </div>
            <button
                type="button"
                className="text-white bg-blue-700 rounded-lg text-sm px-4 py-2 mr-5"
                onClick={onSubmit}
            >
                送信する
            </button>
